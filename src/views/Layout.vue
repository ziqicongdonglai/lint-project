    ...
    <div class="nav">
      <div class="wrap">
        ...
        <div class="logo" @click="goHome">
          <svg viewBox="0 0 64 30" fill="#0066FF" width="64" height="30" class="css-1hlrcxk">
            <path
        ...
        <router-link to="/zhihu.com">首页</router-link>
        <router-link to="/memebr">会员</router-link>
        <router-link to="/find">发现</router-link>
        <router-link to="/wait">等你来答</router-link>
